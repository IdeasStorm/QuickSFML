...
//==================================================================
//========================box20=====================================
Light *box20  = new Light(sf::Vector3f(25.000000,30.000000,-200.000000),90,true);
box20->ambient = sf::Color(1,1,1);
box20->diffuse = sf::Color(1,1,1);
box20->specular = sf::Color(0,0,0);
box20->w = 1 ;
box20->position = Vector3f(25.000000,30.000000,-200.000000); 
box20->halfSize = Vector3f(1.000000,1.000000,1.000000); 
...
//========================box21=====================================
Arch *box21 = new Arch();
box21->position = Vector3f(22.990051,-3.900001,151.106628); 
box21->halfSize = Vector3f(1.000000,1.000000,1.000000); 
