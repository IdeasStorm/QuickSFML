...
public:
    ...
    void Default() {
        ...
        vUp[1] = Up[1];
        vUp[2] = Up[2];
        vForward[0] = Forward[0];
        vForward[1] = Forward[1];
        vForward[2] = Forward[2];
    }
    ...
    void ApplyDefault() {
        ...
        Up[1] = vUp[1];
        Up[2] = vUp[2];
        Forward[0] = vForward[0];
        Forward[1] = vForward[1];
        Forward[2] = vForward[2];
        Origin[0] = vOrigin[0];
        Origin[1] = vOrigin[1];
        Origin[2] = vOrigin[2];
    }
    ...
    inline float GetvOriginX(void) {
        return vOrigin[0];
    }

    inline float GetvOriginY(void) {
        return vOrigin[1];
    }

    inline float GetvOriginZ(void) {
        return vOrigin[2];
    }
