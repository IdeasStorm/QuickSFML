...
${OBJECTDIR}/src/Railway.o: src/Railway.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Railway.o src/Railway.cpp

${OBJECTDIR}/src/DigitalClock.o: src/DigitalClock.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/DigitalClock.o src/DigitalClock.cpp
...
${OBJECTDIR}/src/Arch.o: src/Arch.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Arch.o src/Arch.cpp
