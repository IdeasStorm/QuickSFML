...
${OBJECTDIR}/src/GLScene.o: src/GLScene.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags glew`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/GLScene.o src/GLScene.cpp

${OBJECTDIR}/src/Train.o: src/Train.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags glew`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Train.o src/Train.cpp

${OBJECTDIR}/src/Studio.o: src/Studio.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags glew`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Studio.o src/Studio.cpp

${OBJECTDIR}/src/MyScene.o: src/MyScene.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude `pkg-config --cflags glew`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MyScene.o src/MyScene.cpp
